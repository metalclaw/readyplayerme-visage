...
const Model = ({ scene, scale = 1, modelRef, onLoaded, onSpawnAnimationFinish, bloom, materialConfig, onMeshClick, onMeshHoverStart, onMeshHoverEnd, meshCallback }) => {
    ...
    return (React.createElement("group", { ref: modelRef, dispose: null, rotation: [0, 0, 0], onClick: onClick, onPointerEnter: handlePointerEnter, onPointerLeave: handlePointerLeave },
...
const FloatingModel = ({ modelSrc, scale = 1.0, onLoaded, bloom, onMeshClick, onMeshHoverStart, onMeshHoverEnd, meshCallback }) => {
    ...
    return (React.createElement(Model, { modelRef: ref, scale: scale, scene: scene, onLoaded: onLoaded, bloom: bloom, onMeshClick: onMeshClick, onMeshHoverStart: onMeshHoverStart, onMeshHoverEnd: onMeshHoverEnd, meshCallback: meshCallback }));
};
...
const StaticModel = ({ modelSrc, modelRef, scale = 1, setModelFallback, onLoaded, emotion, bloom, materialConfig, onMeshClick, onMeshHoverStart, onMeshHoverEnd, meshCallback }) => {
    ...
    return (React.createElement(Model, { modelRef: modelRef, scene: scene, scale: scale, onLoaded: onLoaded, bloom: bloom, materialConfig: materialConfig, onMeshClick: onMeshClick, onMeshHoverStart: onMeshHoverStart, onMeshHoverEnd: onMeshHoverEnd, meshCallback: meshCallback }));
};
...
const AnimationModel = ({ modelSrc, animationSrc, rotation = 20 * (Math.PI / 180), scale = 1, idleRotation = false, setModelFallback, onLoaded, headMovement = false, emotion, bloom, materialConfig, onMeshClick, onMeshHoverStart, onMeshHoverEnd, meshCallback }) => {
    ...
    useFallback(nodes, setModelFallback);
    return (React.createElement(Model, { modelRef: ref, scene: scene, scale: scale, onLoaded: onLoaded, onSpawnAnimationFinish: onSpawnAnimationFinish, bloom: bloom, materialConfig: materialConfig, onMeshClick: onMeshClick, onMeshHoverStart: onMeshHoverStart, onMeshHoverEnd: onMeshHoverEnd, meshCallback: meshCallback }));
};
...
const HalfBodyModel = ({ modelSrc, scale = 1, rotation = 20 * (Math.PI / 180), idleRotation = false, emotion, setModelFallback, onLoaded, headMovement = false, bloom, materialConfig, onMeshClick, onMeshHoverStart, onMeshHoverEnd, meshCallback }) => {
    ...
    useEmotion(nodes, emotion);
    useFallback(nodes, setModelFallback);
    return (React.createElement(Model, { modelRef: ref, scene: scene, scale: scale, onLoaded: onLoaded, bloom: bloom, materialConfig: materialConfig, onMeshClick: onMeshClick, onMeshHoverStart: onMeshHoverStart, onMeshHoverEnd: onMeshHoverEnd, meshCallback: meshCallback }));
};
...
const MultipleAnimationModel = ({ modelSrc, animations, activeAnimation, scale = 1, setModelFallback, onLoaded, emotion, bloom, materialConfig, onAnimationEnd, onMeshClick, onMeshHoverStart, onMeshHoverEnd, meshCallback }) => {
    ...
    return (React.createElement(Model, { scene: scene, scale: scale, onLoaded: onLoaded, bloom: bloom, materialConfig: materialConfig, onMeshClick: onMeshClick, onMeshHoverStart: onMeshHoverStart, onMeshHoverEnd: onMeshHoverEnd, meshCallback: meshCallback }));
};
...
const Avatar = ({ modelSrc, animationSrc = undefined, animations = undefined, activeAnimation = undefined, poseSrc = undefined, environment = 'soft', halfBody = false, shadows = false, shadowProperties, scale = 1, animatedCameraSrc, cameraTarget = CAMERA.TARGET.FULL_BODY.MALE, cameraInitialDistance = CAMERA.INITIAL_DISTANCE.FULL_BODY, style, emotion, idleRotation = false, capture, background, onLoaded, onLoading, dpr, className, headMovement = false, cameraZoomTarget = CAMERA.CONTROLS.FULL_BODY.ZOOM_TARGET, onLoadedEffect, onLoadedAnimation, children, effects, keyLightIntensity, keyLightColor, fillLightIntensity, fillLightColor, fillLightPosition, backLightIntensity, backLightColor, backLightPosition, lightTarget, fov = 50, onAnimationEnd, materialConfig, controlsMinDistance, controlsMaxDistance, canvasConfig, onMeshClick, onMeshHoverStart, onMeshHoverEnd, meshCallback }) => {
    ...
    const AvatarModel = useMemo(() => {
        ...
        if (!!activeAnimation && !halfBody && animations) {
            return (React.createElement(MultipleAnimationModelContainer, { emotion: emotion, modelSrc: modelSrc, animations: animations, activeAnimation: activeAnimation, scale: scale, onLoaded: onLoaded, bloom: effects === null || effects === void 0 ? void 0 : effects.bloom, onAnimationEnd: onAnimationEnd, materialConfig: materialConfig, onMeshClick: onMeshClick, onMeshHoverStart: onMeshHoverStart, onMeshHoverEnd: onMeshHoverEnd, meshCallback: meshCallback }));
        }
        if (!!animationSrc && !halfBody && isValidFormat(animationSrc)) {
            return (React.createElement(AnimationModelContainer, { emotion: emotion, modelSrc: modelSrc, animationSrc: animationSrc, scale: scale, idleRotation: idleRotation, onLoaded: onLoaded, headMovement: headMovement, bloom: effects === null || effects === void 0 ? void 0 : effects.bloom, materialConfig: materialConfig, onMeshClick: onMeshClick, onMeshHoverStart: onMeshHoverStart, onMeshHoverEnd: onMeshHoverEnd, meshCallback: meshCallback }));
        }
        if (halfBody) {
            return (React.createElement(HalfBodyModelContainer, { emotion: emotion, modelSrc: modelSrc, scale: scale, idleRotation: idleRotation, onLoaded: onLoaded, headMovement: headMovement, bloom: effects === null || effects === void 0 ? void 0 : effects.bloom, materialConfig: materialConfig, onMeshClick: onMeshClick, onMeshHoverStart: onMeshHoverStart, onMeshHoverEnd: onMeshHoverEnd, meshCallback: meshCallback }));
        }
        if (isValidFormat(poseSrc)) {
            return (React.createElement(PoseModelContainer, { emotion: emotion, modelSrc: modelSrc, scale: scale, poseSrc: poseSrc, onLoaded: onLoaded, bloom: effects === null || effects === void 0 ? void 0 : effects.bloom, materialConfig: materialConfig, onMeshClick: onMeshClick, onMeshHoverStart: onMeshHoverStart, onMeshHoverEnd: onMeshHoverEnd, meshCallback: meshCallback }));
        }
        return (React.createElement(StaticModelContainer, { modelSrc: modelSrc, scale: scale, onLoaded: onLoaded, emotion: emotion, bloom: effects === null || effects === void 0 ? void 0 : effects.bloom, materialConfig: materialConfig, onMeshClick: onMeshClick, onMeshHoverStart: onMeshHoverStart, onMeshHoverEnd: onMeshHoverEnd, meshCallback: meshCallback }));
    }, [
        modelSrc,
        activeAnimation,
        halfBody,
    ...
    return (React.createElement(BaseCanvas, { enablePostProcessing: enablePostProcessing, position: new Vector3(0, 0, 3), fov: fov, style: style, dpr: dpr, className: className, canvasConfig: canvasConfig },
        ...
        AvatarModel,
        children,
        shadows && (React.createElement(ContactShadows, Object.assign({ opacity: (effects === null || effects === void 0 ? void 0 : effects.ambientOcclusion) ? 1.25 : 2, blur: 2, scale: 4, far: 1.0, resolution: 256 }, shadowProperties))),
